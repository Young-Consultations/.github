...
| GH-FR-008–012 | Domain Model, Data Flow, State Models, Error Handling, ADR-004/005/008 |
...
| GH-QR-* | Component/Low-Level Design, Observability, Release/compatibility decisions |
