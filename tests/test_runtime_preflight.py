...
def test_current_runtime_record_is_generated_from_authoritative_state():
    ...
    assert value["control_plane"]["tag"] == "ai-sdlc-v2.4.2"
    assert value["control_plane"]["tag_commit_sha"] == (
        "1ea59832996dc398923c2d1516eb464546e30877"
    )
...
def test_missing_audit_token_reports_failed_credential_boundary(
    ...
    monkeypatch.setattr(
        runtime_preflight,
        "remote_tag_commit",
        lambda tag: "1ea59832996dc398923c2d1516eb464546e30877",
    )
...
def test_remote_release_tag_resolves_lightweight_commit(monkeypatch):
    ...
    assert runtime_preflight.remote_tag_commit("ai-sdlc-v2.4.2") == "a" * 40
...
def test_remote_release_tag_resolves_annotated_tag(monkeypatch):
    ...
    assert runtime_preflight.remote_tag_commit("ai-sdlc-v2.4.2") == "c" * 40
